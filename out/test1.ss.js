...
//@ sourceMappingURL=core.js.map
	...
	var code = core.SExprList.create(core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("define"),core.SList.create(core.SIdentifier.create("core-macro"),core.SList.create(core.SString.create("name"),core.SString.create("value")),core.SList.create(core.SIdentifier.create("cons2"),core.SList.create(core.SIdentifier.create("symbol"),core.SString.create("core-define")),core.SList.create(core.SIdentifier.create("cons"),core.SList.create(core.SIdentifier.create("str"),core.SIdentifier.create("name")),core.SIdentifier.create("value"))))),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("set"),core.SList.create(core.SIdentifier.create("core-macro"),core.SList.create(core.SString.create("name"),core.SString.create("value")),core.SList.create(core.SIdentifier.create("cons2"),core.SList.create(core.SIdentifier.create("symbol"),core.SString.create("core-set")),core.SList.create(core.SIdentifier.create("cons"),core.SList.create(core.SIdentifier.create("str"),core.SIdentifier.create("name")),core.SIdentifier.create("value"))))),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("println"),core.SList.create(core.SIdentifier.create("core-lambda"),core.SList.create(core.SIdentifier.create("quote"),core.SList.create(core.SString.create("value"))),core.SList.create(core.SIdentifier.create("quote"),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("display"),core.SIdentifier.create("value")),core.SList.create(core.SIdentifier.create("newline")))))),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("print"),core.SIdentifier.create("display")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("all-sym-to-str"),core.SList.create(core.SIdentifier.create("core-lambda"),core.SList.create(core.SIdentifier.create("quote"),core.SList.create(core.SString.create("items"))),core.SList.create(core.SIdentifier.create("quote"),core.SList.create(core.SIdentifier.create("map"),core.SIdentifier.create("sym->str"),core.SIdentifier.create("items"))))),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("lambda"),core.SList.create(core.SIdentifier.create("core-macro"),core.SList.create(core.SString.create("params"),core.SString.create("body")),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("core-set"),core.SString.create("params"),core.SList.create(core.SIdentifier.create("all-sym-to-str"),core.SIdentifier.create("params"))),core.SList.create(core.SIdentifier.create("core-lambda"),core.SIdentifier.create("params"),core.SIdentifier.create("body"))))),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("macro"),core.SList.create(core.SIdentifier.create("core-macro"),core.SList.create(core.SString.create("params"),core.SString.create("body")),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("core-set"),core.SString.create("params"),core.SList.create(core.SIdentifier.create("all-sym-to-str"),core.SIdentifier.create("params"))),core.SList.create(core.SIdentifier.create("realize"),core.SList.create(core.SIdentifier.create("cons2"),core.SList.create(core.SIdentifier.create("symbol"),core.SString.create("core-macro")),core.SList.create(core.SIdentifier.create("cons"),core.SIdentifier.create("params"),core.SIdentifier.create("body"))))))),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("defmacro"),core.SMacro.create([core.SString.create("name"),core.SString.create("params"),core.SString.create("body")],core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("cons2"),core.SList.create(core.SIdentifier.create("symbol"),core.SString.create("define")),core.SList.create(core.SIdentifier.create("cons"),core.SIdentifier.create("name"),core.SList.create(core.SIdentifier.create("cons2"),core.SList.create(core.SIdentifier.create("symbol"),core.SString.create("macro")),core.SList.create(core.SIdentifier.create("cons"),core.SIdentifier.create("params"),core.SIdentifier.create("body")))))),"")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("defn"),core.SMacro.create([core.SString.create("name"),core.SString.create("params"),core.SString.create("body")],core.SList.create(core.SIdentifier.create("realize"),core.SList.create(core.SIdentifier.create("list"),core.SList.create(core.SIdentifier.create("symbol"),core.SString.create("define")),core.SIdentifier.create("name"),core.SList.create(core.SIdentifier.create("list"),core.SList.create(core.SIdentifier.create("symbol"),core.SString.create("lambda")),core.SIdentifier.create("params"),core.SIdentifier.create("body")))),"")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("log"),core.SMacro.create([core.SString.create("item")],core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SString.create("log: ")),core.SList.create(core.SIdentifier.create("println"),core.SIdentifier.create("item"))),"")),core.SList.create(core.SIdentifier.create("log"),core.SString.create("hello-world")),core.SList.create(core.SIdentifier.create("if"),core.SList.create(core.SIdentifier.create("="),core.SList.create(core.SIdentifier.create("+"),core.SNumber.create(1),core.SNumber.create(1)),core.SList.create(core.SIdentifier.create("-"),core.SNumber.create(3),core.SNumber.create(1),core.SNumber.create(0))),core.SList.create(core.SIdentifier.create("println"),core.SString.create("true")),core.SList.create(core.SIdentifier.create("println"),core.SString.create("false"))),core.SList.create(core.SIdentifier.create("println"),core.SList.create(core.SIdentifier.create("call/cc"),core.SFunc.create([core.SString.create("ret")],core.SList.create(core.SIdentifier.create("ret"),core.SString.create("hello, call/cc!")),""))),core.SList.create(core.SIdentifier.create("display"),core.SString.create("abc"),core.SNumber.create(234)),core.SList.create(core.SIdentifier.create("newline")),core.SList.create(core.SIdentifier.create("core-set"),core.SString.create("l1"),core.SList.create(core.SIdentifier.create("list"),core.SString.create("a1"),core.SString.create("b2"),core.SString.create("c2"))),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SString.create("list l1 is")),core.SList.create(core.SIdentifier.create("println"),core.SIdentifier.create("l1"))),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SString.create("length of l1 is")),core.SList.create(core.SIdentifier.create("println"),core.SList.create(core.SIdentifier.create("count"),core.SIdentifier.create("l1")))),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SString.create("the 3rd of l1 is")),core.SList.create(core.SIdentifier.create("println"),core.SList.create(core.SIdentifier.create("nth"),core.SIdentifier.create("l1"),core.SNumber.create(2)))),core.SList.create(core.SIdentifier.create("println"),core.SString.create("fibonacci test:")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("hello"),core.SFunc.create([core.SString.create("name")],core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SString.create("Hello")),core.SList.create(core.SIdentifier.create("println"),core.SIdentifier.create("name"))),"")),core.SList.create(core.SIdentifier.create("hello"),core.SString.create("World!")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("fib"),core.SFunc.create([core.SString.create("n")],core.SList.create(core.SIdentifier.create("if"),core.SList.create(core.SIdentifier.create("<"),core.SIdentifier.create("n"),core.SNumber.create(3)),core.SNumber.create(1),core.SList.create(core.SIdentifier.create("+"),core.SList.create(core.SIdentifier.create("fib"),core.SList.create(core.SIdentifier.create("-"),core.SIdentifier.create("n"),core.SNumber.create(1))),core.SList.create(core.SIdentifier.create("fib"),core.SList.create(core.SIdentifier.create("-"),core.SIdentifier.create("n"),core.SNumber.create(2))))),"")),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SString.create("fib 15 =")),core.SList.create(core.SIdentifier.create("println"),core.SList.create(core.SIdentifier.create("fib"),core.SNumber.create(15)))),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("say-hi"),core.SFunc.create([core.SString.create("msg"),core.SString.create("name")],core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SIdentifier.create("msg")),core.SList.create(core.SIdentifier.create("println"),core.SIdentifier.create("name"))),"")),core.SList.create(core.SIdentifier.create("say-hi"),core.SString.create("welcome"),core.SString.create("zoowii")),core.SList.create(core.SIdentifier.create("println"),core.SList.create(core.SIdentifier.create("+"),core.SNumber.create(1),core.SNumber.create(2),core.SNumber.create(3),core.SNumber.create(4),core.SNumber.create(5))),core.SList.create(core.SIdentifier.create("println"),core.SString.create("hashmap test")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("m1"),core.SList.create(core.SIdentifier.create("hashmap"),core.SList.create(core.SIdentifier.create("list"),core.SString.create("a"),core.SString.create("b"),core.SString.create("c")),core.SList.create(core.SIdentifier.create("list"),core.SString.create("hello"),core.SIdentifier.create("list"),core.SNumber.create(123)))),core.SList.create(core.SIdentifier.create("println"),core.SIdentifier.create("m1")),core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("print"),core.SList.create(core.SIdentifier.create("hashmap-get"),core.SIdentifier.create("m1"),core.SString.create("a"))),core.SList.create(core.SIdentifier.create("print"),core.SList.create(core.SIdentifier.create("hashmap-get"),core.SIdentifier.create("m1"),core.SString.create("c"))),core.SList.create(core.SIdentifier.create("println"),core.SList.create(core.SIdentifier.create("hashmap-get"),core.SIdentifier.create("m1"),core.SString.create("d"),core.SString.create("not found return value")))),core.SList.create(core.SIdentifier.create("println"),core.SString.create("世界\n你好")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("http"),core.SList.create(core.SIdentifier.create("js-call-function"),core.SIdentifier.create("context"),core.SString.create("getModule"),core.SList.create(core.SIdentifier.create("list"),core.SString.create("http")))),core.SList.create(core.SIdentifier.create("display-js-obj"),core.SIdentifier.create("http")),core.SList.create(core.SIdentifier.create("newline")),core.SList.create(core.SIdentifier.create("js-call-function"),core.SIdentifier.create("context"),core.SString.create("sayHi"),core.SList.create(core.SIdentifier.create("list"))),core.SList.create(core.SIdentifier.create("newline")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("plain-http-head"),core.SList.create(core.SIdentifier.create("js-create-object"))),core.SList.create(core.SIdentifier.create("js-set-property"),core.SIdentifier.create("plain-http-head"),core.SString.create("Content-Type"),core.SString.create("text/html")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("create-http-server"),core.SFunc.create([core.SString.create("handler")],core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("core-set"),core.SString.create("server"),core.SList.create(core.SIdentifier.create("js-call-function"),core.SIdentifier.create("http"),core.SString.create("createServer"),core.SList.create(core.SIdentifier.create("list"),core.SList.create(core.SIdentifier.create("make-js-function"),core.SIdentifier.create("handler"))))),core.SIdentifier.create("server")),"")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("http-handler"),core.SFunc.create([core.SString.create("req"),core.SString.create("res")],core.SList.create(core.SIdentifier.create("do"),core.SList.create(core.SIdentifier.create("js-call-function"),core.SIdentifier.create("res"),core.SString.create("writeHead"),core.SList.create(core.SIdentifier.create("list"),core.SNumber.create(200),core.SIdentifier.create("plain-http-head"))),core.SList.create(core.SIdentifier.create("js-call-function"),core.SIdentifier.create("res"),core.SString.create("end"),core.SList.create(core.SIdentifier.create("list"),core.SString.create("Hello, World!<h1>SchemePy</h1><h3>Written by SchemePy(compiled to javascript and running on Node.)</h3><h3>Author: zoowii</h3><h3><a href='https://github.com/zoowii/SchemePy'>Github</a></h3>")))),"")),core.SList.create(core.SIdentifier.create("display-js-obj"),core.SList.create(core.SIdentifier.create("make-js-function"),core.SIdentifier.create("http-handler"))),core.SList.create(core.SIdentifier.create("newline")),core.SList.create(core.SIdentifier.create("display-js-obj"),core.SIdentifier.create("plain-http-head")),core.SList.create(core.SIdentifier.create("newline")),core.SList.create(core.SIdentifier.create("core-define"),core.SString.create("server"),core.SList.create(core.SIdentifier.create("create-http-server"),core.SIdentifier.create("http-handler"))),core.SList.create(core.SIdentifier.create("display-js-obj"),core.SIdentifier.create("server")),core.SList.create(core.SIdentifier.create("newline")),core.SList.create(core.SIdentifier.create("js-call-function"),core.SIdentifier.create("server"),core.SString.create("listen"),core.SList.create(core.SIdentifier.create("list"),core.SNumber.create(5000),core.SString.create("127.0.0.1"))));
